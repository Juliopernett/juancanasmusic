# Juan Cañas — Brochure Digital

Sitio oficial de Juan Cañas. Next.js 16 + TypeScript + Tailwind + Framer Motion.
Publicado en `https://juancanasmusic.portalvallenato.com` vía GitHub → Railway.
...
1. Crea una hoja de Google Sheets con estas columnas exactas en la primera fila:
   ...
   |---|---|---|---|---|
   | 15/08/2026 | Barranquilla | Plaza Principal | Fiestas Patronales | Confirmado |
